...
public class SetDrawPasswdActivity$$ViewInjector {
  public static void inject(Finder finder, final bitman.ay27.watchdog.ui.activity.SetDrawPasswdActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427554, "field 'canvas'");
    target.canvas = (bitman.ay27.watchdog.ui.activity.widget.DrawingCanvas) view;
    view = finder.findRequiredView(source, 2131427555, "field 'widgetView'");
    target.widgetView = view;
    view = finder.findRequiredView(source, 2131427556, "field 'changeImgBtn' and method 'changeImgClick'");
    ...
    view = finder.findRequiredView(source, 2131427557, "field 'saveBtn' and method 'saveClick'");
