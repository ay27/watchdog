...
public class SetDrawPasswdActivity$$ViewInjector {
  public static void inject(Finder finder, final bitman.ay27.watchdog.ui.activity.SetDrawPasswdActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427526, "field 'canvas'");
    target.canvas = (bitman.ay27.watchdog.ui.activity.widget.DrawingCanvas) view;
    view = finder.findRequiredView(source, 2131427527, "field 'widgetView'");
    target.widgetView = view;
    view = finder.findRequiredView(source, 2131427528, "field 'changeImgBtn' and method 'changeImgClick'");
    ...
    view = finder.findRequiredView(source, 2131427529, "field 'saveBtn' and method 'saveClick'");
