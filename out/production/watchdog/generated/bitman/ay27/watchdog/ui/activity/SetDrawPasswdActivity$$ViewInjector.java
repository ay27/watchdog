...
public class SetDrawPasswdActivity$$ViewInjector {
  public static void inject(Finder finder, final bitman.ay27.watchdog.ui.activity.SetDrawPasswdActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131427470, "field 'canvas'");
    target.canvas = (bitman.ay27.watchdog.ui.DrawingCanvas) view;
    view = finder.findRequiredView(source, 2131427471, "field 'widgetView'");
    target.widgetView = view;
    view = finder.findRequiredView(source, 2131427472, "field 'changeImgBtn' and method 'changeImgClick'");
    ...
    view = finder.findRequiredView(source, 2131427473, "field 'saveBtn' and method 'saveClick'");
