...
//    }
    ...
    public AngleChain(RhythmPoint start_point, RhythmPoint end_point, double segment_length, int num_of_segments) {
        this.start_point = start_point;
...
//        this.x =start_point.x; this.y = start_point.y; this.timestamp = start_point.timestamp;
    ...
    public void bind(AngleChain chain) {
        ...
        end_point.x = (int) _bind(end_point.x, chain.end_point.x);
        end_point.y = (int) _bind(end_point.y, chain.end_point.y);
        start_point.timestamp = (long) _bind(start_point.timestamp, chain.start_point.timestamp);
        end_point.timestamp = (long) _bind(end_point.timestamp, chain.end_point.timestamp);
//        this.x = start_point.x; this.y = start_point.y; this.timestamp = start_point.timestamp;
