 ...
 */
public class BluetoothLeServiceParamPost implements Parcelable {
    ...
    private BluetoothLeServiceParamPost(Parcel in) {
        this.name = in.readInt();
        this.len = in.readInt();
        in.readByteArray(data);
    }

    public static final Creator<BluetoothLeServiceParamPost> CREATOR = new Creator<BluetoothLeServiceParamPost>() {
        public BluetoothLeServiceParamPost createFromParcel(Parcel in) {
            return new BluetoothLeServiceParamPost(in);
        }

        public BluetoothLeServiceParamPost[] newArray(int size) {
            return new BluetoothLeServiceParamPost[size];
        }
    };
    ...
    public BluetoothLeServiceParamPost() {
